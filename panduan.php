...
include "header.php";
 ?>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Panduan Praktis</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- /.content-header -->
    <div class="col-lg-3 col-xs-6"><a href="./add_panduan.php" class="small-box-footer">
            <div class="small-box bg-blue">
                  <div class="inner">
                      <H5>Tambah Panduan <i class="fa fa-arrow-circle-right"></i></H5>
                      <div class="icon">
          ...
          <div class="col-md-12">
                         <div class="card">
                           <div class="card-header">
                             <h3 class="card-title">Panduan Praktis</h3>
                           </div>
                           <div class="card-body">
                    ...
                    <?php
                    $nomor = 1;
                    $results = mysqli_query($conn, "SELECT * FROM panduan_praktis");

...
<!-- /.content-header -->
<div class="col-lg-3 col-xs-6"><a href="./add_inspirasi.php" class="small-box-footer">
            <div class="small-box bg-blue">
                  <div class="inner">
                      <H5>Tambah Inspirasi <i class="fa fa-arrow-circle-right"></i></H5>
                      <div class="icon">
          ...
          <div class="col-md-12">
                         <div class="card">
                           <div class="card-header">
                             <h3 class="card-title">Daftar Inspirasi</h3>
                           </div>
                           <div class="card-body">
                    ...
                    <?php
                    $nomor = 1;
                    $results = mysqli_query($conn, "SELECT * FROM inspirasi");
